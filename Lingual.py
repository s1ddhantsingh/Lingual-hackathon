...
@NLP.route('/process_form', methods=['POST'])
def process_form():
    name = request.form['name']
    # do something with the data (e.g. validate, store in a database, etc.)
    return f"Hello {correct_spelling(name)}, thanks for submitting your email!"
